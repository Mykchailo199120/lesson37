...
console.log(calculator.add(2, 3)); // Виведе: "Calling "add" with arguments: 2, 3" та 5
console.log(calculator.multiply(3, 4)); // Виведе: "Calling "multiply" with arguments: 3, 4" та 12
/*
 * #3
 *
